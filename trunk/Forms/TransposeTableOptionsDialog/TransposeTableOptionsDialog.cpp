// ***********************************************************************************************
// *                                                                                             *
// * TransposeTableOptionsDialog.cpp - sets transpose table options                              *
// *                                                                                             *
// * Dr. Rainer Sieger - 2014-09-07                                                              *
// *                                                                                             *
// ***********************************************************************************************
...
#include "TransposeTableOptionsDialog.h"

TransposeTableOptionsDialog::TransposeTableOptionsDialog( QWidget *parent ) : QDialog( parent )
{
    setupUi( this );
...
int MainWindow::doTransposeTableOptionsDialog( int &i_CodecInput, int &i_CodecOutput, int &i_EOL, bool &b_DeleteInputFile )
{
    int i_DialogResult = QDialog::Rejected;

// ***********************************************************************************************************************

    TransposeTableOptionsDialog dialog( this );
