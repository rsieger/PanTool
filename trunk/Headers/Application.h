...
public:
    ...
    // polyCentroid
    bool        gb_pc_DeleteInputFile;               //!< loesche Inputdatei
...
// *********************************************************************************************************************
    ...
    int extractColumns( const QString &FilenameIn, const QString &FilenameOut, const int CodecInput, const int CodecOutput, const int EOL, const QStringList &Input, const QString &ColumnList = "", const bool SkipEmptyLines = false, const bool SkipCommentLines = false, const int NumOfFiles = 0 );
    int extractLines( const QString &s_FilenameIn, const QString &s_FilenameOut, const int CodecInput, const int CodecOutput, const int EOL, const int StartLine = 1, const int Increment = 1, const int NumberOfLines = 1, const bool ExtractFristLineLastLine = false, const bool SkipEmptyLines = false, const bool SkipCommentLines = false, const int NumOfFiles = 0 );
    int extractMatchedColumns( const QString &FilenameIn, const QString &FilenameOut, const int CodecInput, const int CodecOutput, const int EOL, const QString &SearchString = "", const bool SaveNoMatch = false, const bool SkipEmptyLines = false, const bool SkipCommentLines = false, const bool DeleteEmptyOutputFile = false, const int NumOfFiles = 0 );
    ...
    int extract10minLines( const QString &FilenameIn, const QString &FilenameOut, const int CodecInput, const int CodecOutput, const int EOL, const bool SkiptFirstLine = true, const int NumOfFiles = 0 );

    int deleteColumns( const QString &FilenameIn, const QString &FilenameOut, const int CodecInput, const int CodecOutput, const int EOL, const QString &ColumnList = "", const bool SkipEmptyLines = false, const bool SkipCommentLines = false, const int NumOfFiles = 0 );
    int deleteLines( const QString &FilenameIn, const QString &FilenameOut, const int CodecInput, const int CodecOutput, const int EOL, const int StartLine = 1, const int NumberOfLines = 1, const bool SkipEmptyLines = false, const bool SkipCommentLines = false, const int NumOfFiles = 0 );
    int deleteMatchedColumns( const QString &FilenameIn, const QString &FilenameOut, const int CodecInput, const int CodecOutput, const int EOL, const QString &SearchString = "", const bool SkipEmptyLines = false, const bool SkipCommentLines = false, const int NumOfFiles = 0 );
    int deleteMatchedLines( const QString &FilenameIn, const QString &FilenameOut, const int CodecInput, const int CodecOutput, const int EOL, const QString &SearchString = "", const bool SkipEmptyLines = false, const bool SkipCommentLines = false, const int NumOfFiles = 0 );

    int deleteDoubleLines( const QString &FilenameIn, const QString &FilenameOut, const int CodecInput, const int CodecOutput, const int EOL, const bool SkipEmptyLines = false, const bool SkipCommentLines = false, const int NumOfFiles = 0 );
    int deleteCommentBlocks( const QString &FilenameIn, const QString &FilenameOut, const int CodecInput, const int CodecOutput, const int EOL, const bool SkipEmptyLines = false, const bool SkipCommentLines = false, const int NumOfFiles = 0 );

    int insertCharactersAtPosition( const QString &FilenameIn, const QString &FilenameOut, const int CodecInput, const int CodecOutput, const int EOL, const QString &CharacterPositionList = "", const QString &InsertStr = "", const bool SkipEmptyLines = false, const bool SkipCommentLines = false, const int NumOfFiles = 0 );
    int replaceCharactersAtPosition( const QString &FilenameIn, const QString &FilenameOut, const int CodecInput, const int CodecOutput, const int EOL, const QString &CharacterPositionList = "", const QString &ReplaceStr = "", const bool SkipEmptyLines = false, const bool SkipCommentLines = false, const int NumOfFiles = 0 );

    int searchOneString( const int ActionNumber, const QString &FilenameFormat, const int Extension, const QStringList &FilenameList, const QString &FilenameOut, const int CodecInput, const int CodecOutput, const int EOL, const QString &SearchStr = "", const int StartLine = 1, const int NumberOfLines = 0, const bool SkipEmptyLines = false, const bool SkipCommentLines = false, const bool DeleteEmptyOutputFile = false );
    int searchAndReplaceOneString( const QString &FilenameIn, const QString &FilenameOut, const int CodecInput, const int CodecOutput, const int EOL, const QString &SearchStr = "", const QString &ReplaceStr = "", const int StartLine = 1, const int NumberOfLines = 0, const bool SkipEmptyLines = false, const bool SkipCommentLines = false, const int NumOfFiles = 0 );
    int searchAndReplaceManyStringsAtOnce( const QString &FilenameIn, const QString &FilenameOut, const int CodecInput, const int CodecOutput, const int EOL, const QStringList &SearchStrings, const QStringList &ReplaceStrings, const int StartLine = 1, const int NumberOfLines = 0, const int SearchAndReplaceMode = _LINE, const bool SkipEmptyLines = false, const bool SkipCommentLines = false, const int NumOfFiles = 0 );
    ...
    int findArea( const QString &FilenameIn, const QString &FilenameOut, const int CodecInput, const int CodecOutput, const int EOL, QVector<AreaItem> &Area, QVector<PositionItem> &Position, const int NumOfFiles = 0 );
    ...
    int doDateTimeDialog( int &DateColumn, int &YearColumn, int &MonthColumn, int &DayColumn, int &TimeColumn, int &HourColumn, int &MinuteColumn, int &SecondColumn, int &DateTimeColumn,  int &DayOfYearColumn, int &JulianDayColumn, int &MatLabDateColumn, bool &WriteDateTimeOnly, int &OutputFormatDateTime );
    int doDeleteLinesDialog( int &StartLine, int &NumberOfLines, bool &SkipEmptyLines, bool &SkipCommentLines, bool &DeleteInputFile );
    int doFileListOptionsDialog( QString &LocalDataDir, QString &ExternalWebPath );
