...
cp -R './build-PanTool-Desktop_Qt_5_8_0_clang_64bit-Release/PanTool.app' '../../Distribution/PanTool/PanTool.app'
cp './trunk/Resources/Info.plist' '../../Distribution/PanTool/PanTool.app/Contents/Info.plist'

/Developer/Qt/5.8/clang_64/bin/macdeployqt '../../Distribution/PanTool/PanTool.app'
